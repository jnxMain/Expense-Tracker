    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <section className="metric-grid">
          ...
          <div className="metric-card"><div className="metric-label">Income <span className="green-icon">↑</span></div><div className="metric-value">{formatCurrency(totalIncome)}</div><div className="metric-foot muted">This {period === 'month' ? 'month' : 'year'}</div></div>
        </section>
        ...
        <div className="mobile-actions"><button className="mobile-targets-button" onClick={() => document.querySelector('.budget-panel')?.scrollIntoView({ behavior: 'smooth' })}>Edit Targets</button><button className="mobile-add-button" onClick={() => document.querySelector('.transactions-panel')?.scrollIntoView({ behavior: 'smooth' })}><span>＋</span> Add Transaction</button></div>
